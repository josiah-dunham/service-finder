...
const IGNOREDPORTS = [] // Ports to ignore in fetch requests // If there are any known problem ports, or known open ports that are not Drive and worth skipping since it is irrelevant, they can be added to this array and no fetch request will be made to it.
